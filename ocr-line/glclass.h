...
namespace glinerec {
    ...
    struct IOmpClassifier {
        virtual ~IOmpClassifier() {}
        virtual void load(const char *file) = 0;
        virtual void setClassifier(IModel *model) = 0;
        virtual void classify() = 0;
        virtual void resize(int n) = 0; 
        virtual void input(floatarray &a,int i) = 0;
        virtual void output(OutputVector &ov,int i) = 0;
    };
